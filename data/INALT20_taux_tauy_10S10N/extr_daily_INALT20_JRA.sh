#!/bin/bash
#SBATCH --job-name=job_extr_5d_INATL20_JRA_tau
#SBATCH --nodes=20
#SBATCH --tasks-per-node=4
#SBATCH --cpus-per-task=4
#SBATCH --mem=64000
#SBATCH --time=02:00:00
#SBATCH --output=job_extr_5d_JRA_tau.out
#SBATCH --error=job_extr_5d_JRA_tau.err
...
OUTPATH=/gxfs_work1/geomar/smomw294/iAtlantic/Subprojects/Wind_forcing/data/INALT20_taux_tauy_10S10N

regNo='windstress_10S10N_65W15E'
...
#         ncrcat -O -d x,${regimin},${regimax} -d y,${regjmin},${regjmax} -v sozotaux $bnam $fnam; \
...
#     (bnam=${INPATH}/1_${COCA1}_${TPER}_${yy}0101_${yy}1231_${vv}.nc; \
#     fnam=${OUTPATH}/1_${COCA1}_${TPER}_${yy}0101_${yy}1231_${regNo}_${vv}.nc; \
#         ncrcat -O -d x,${regimin},${regimax} -d y,${regjmin},${regjmax} -v sometauy $bnam $fnam; \
#     ncatted -O -a pi,global,c,c,"${VAR_PI}"  -a pi_email,global,c,c,"${VAR_PICONTACT}"  \
#                -a experiment_name,global,c,c,"${VAR_EXPCONF}"  -a experiment_id,global,c,c,"${VAR_EXPCASE}" \
#                -a title,global,c,c,"${VAR_EXPLONG}" \
#                -a institution_id,global,c,c,"${VAR_INSTID}"  -a institution,global,c,c,"${VAR_INSTLONG}" \
