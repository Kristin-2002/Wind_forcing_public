#!/bin/bash
#SBATCH --job-name=job_extr_v_TIW_CORE
#SBATCH --nodes=20
#SBATCH --tasks-per-node=4
#SBATCH --cpus-per-task=4
#SBATCH --mem=64000
#SBATCH --time=02:00:00
#SBATCH --output=job_extr_v_TIW_CORE.out
#SBATCH --error=job_extr_v_TIW_CORE.err
...
OUTPATH=/gxfs_work1/geomar/smomw294/iAtlantic/Subprojects/Wind_forcing/data/INALT20_meridional_Velocity_TIWs/

#regNo='vomecrty_3n7n_30w10w'
#regjmin=1689 #lat indices obtained using ../scripts/INALT20_extract_regions_indices.ipynb
#regjmax=1768
#regimin=789  #lon
#regimax=1189
#zimin=12
...
regNo='vomecrty_3s7s_30w00w'
regjmin=1489 #lat indices obtained using ../scripts/INALT20_extract_regions_indices.ipynb
regjmax=1568
regimin=789 #lon
regimax=1389
zimin=12
