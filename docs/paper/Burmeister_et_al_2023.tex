...
%Climate models predict a decline of the AMOC volume transport under global warming \cite[e.g.][]{Lee2021,Caesar2018} which could not yet be confirmed by AMOC observational studies \citep{Moat2020,Fu2020,Worthington2021}. The tropical Atlantic zonal current system plays an active role for the gain of heat and salt by the AMOC. Understanding its long-term changes like multidecadal variability and trends is of great importance which largely depends on model simulations. 
...
%The tropical Atlanticexhibits a strong annual cycle forced by the annual mi-gration of the intertropical convergence zone (e.g., Katz and Garzoli 1982; Katz 1987).
...
\begin{figure}[t]
	\includegraphics[width=12cm]{../../figures/paper/f06_INALT20_AH_MODE4.eps}
...
\codedataavailability{All necessary code for the data analysis and preparation of the figures of this manuscript is freely available at \url{https://github.com/Kristin-2002/Wind_forcing.git}. All observational data supporting the findings of this study are publicly available as referenced within the paper. Model output necessary to reproduce the presented findings are available at https://data.geomar.de/downloads/20.500.12085/77c0d676-1933-4f17-9849-5ea2161736eb/.} %% use this section when having data sets and software code available
...
\begin{table}[t]
	...
	\end{tabular}
	\label{tab_cruises}
	\belowtable{$ ^{*} $Cruises used to derived the buyoance frequency profile at 23$^{\circ}$W, 0$^{\circ}$N} % Table Footnotes
\end{table}
\clearpage
\begin{table}[t]
...
\clearpage
\begin{figure}[t]
	\includegraphics[height=12cm]{../../figures/paper/fA3_JRA_CORE_AH_M1M5_1980_2009.png}
...
\clearpage
\begin{figure}[t]
	\includegraphics[width=12cm]{../../figures/paper/fA6_2deg_INALT20_curl_and_sverdrup_maps_mean_1980_2009.png}
...
\competinginterests{The contact author has declared that none of the authors has any competing interests.} %% this section is mandatory even if you declare that no competing interests are present
